...
Typicly the S1 layer is thin and comprises of ---- The S2 layer bound to the inside of
S1 is typicly much thicker and has more verticly orentated micorfibrils
compeared to the primary, S1 and S3 layers -----. In some cases, most commonly
in late wood an S3 layer is also produced -----
Finally if tension wood is being produced a Gelatonus layer is produed on the
indide if the inner most wall (S2 or S3). The G-layer has near verticly
orentated microfibrils and very little lignification. It is suspected that the
...
Most work early on in the study of growth stresses sorounded investigating why
boards changed shape when cut from an intact stem.
...
lignin swelling
Boyd 1972 compressive stress originating in the matrix refion pushes the CW
