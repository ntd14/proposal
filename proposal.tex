...
Currently there are three commanly used experimental methods for measuring
surface strains. The Nicholson (1971) method, the `French' method and the strain
gauge method.

After the deveopmetens of Boyd and Jacobs in testing for growth stresses it
became aparent there was a need for a rapid testing procidure. Nicholson (1971)
developed the first of these measuring the releced strain between two metel pins
on the surface of the sample, cut from the surface of logs. While considered a
rapid method in 1971, updated versions of this test are still used for meauring surface strains but
not practical for (or considered rapid) for testing larger numbers of stems such
as in breeding trials. The `French` method (current iteration Gerard et al 1995)
involves drilling a hole between two reference points, with a dial measuring the
distance change between the two points.

Okuyama et al (1981) adopted the use of strain gauges to meausre stem surface
...
kiwa 1977 investigated drilling holes near strain gueges to release strains.
Saurat and Gueneau 1974, 1976 introduced an apperatause which utalised two knife
...
adopted Jacobs planking method and eletric strain guages for improved acuracy.
Kubler (1959) and Wilhelmy and Kubler (1973) drilled holes of known diameters into stems and
atempted to measure the change in shape of the hole as the log was sucsevely
crosscut closer to the test site, as Boyd (1950) had done. Ploge and Thiercelin
1979 atempted to measure the effect of growth stresses on increment cores,
although they found that the stresses had an effect on the corer its self
squashing it into an oval shape. Ferrand 1982 found a corelation between
longitudnal strain and tangential core diameter between -0.67 and -0.77, showing
...
regarding the reasion for the development of reaction wood. He argued that (as
had been previously rejected) the stress hypothesis, claiming that reaction wood
is a responce to imposed stresses is the only available hypothesis which fits
the data, and that previous efforts to reject it had resulted from
misinterprited results. In doing this he provides reasioning to reject the
hypothosis regarding gravitational reponces, intrinsic growth direction, auxin
distrobution and turgor pressure.

--timell compression wood in geynosperms

The Poisson effect is the revelation that a change of dimention of a material
in one direction will result in a change of dimention in the other directions,
this relationship is charachterised by the Poisson ratio. Within growth stress
litriture there has been some investigation of this effect as it apears the
redistrobution of stress through the Poisson ratio from the longitudinal to
tangential direction is not sifficent to account for the observed trangential
strains, which can varry even for a given longitudnal strain.

It is worth noting that because bark is also formed by cambrial cells
differentrating, when the cambium devides to the outside, the cells (typicly)
...
from the cambium, however the ramaining ring can still be providing a
...
al 1981 measured 750micro strains in Japanese cedar. Bark is often observed to
...
outer reagions of the bark layer.

After Bamber 1979 disputed the reliablity of Boyd 1972, Boyd 1985 and Bamber
1987 disputed each others analysis's however no new information was presented,
rather a number of issues around interpeting biological data were highlighted.
...
presents a table summarising the litriture reporting strains for different
species, highlighting the large intra and inter tree varation even within a
single species.
...
--- Brief note that cellular models which do not consider growth stresses. Ref
a review paper---
...
Unfortunatly most litriture has investigated very few samples and reports high
varability within individuals and species,---
...
Tangential stresses have been sugested to resist mechanical failure in times of
frost (when water inside the cells frezes and expands) and drought (when water
...
around the saw cuts causing shortening at the periphery and extension in the centre. The
...
\section{Intentions and Objectives}
...
\section{Timeline}
Proposal due
Dec harewood harvest and analyisis
next harewood harvest and analysis
seting up loop and bending trials
harvesting loops and bending trials, re-establish loops
init anatomy study
single cell model --break up---
multi cell model --break up--
woodville setup, visit, harvest
woodville analysis
enzime exp

\section{Projected publications}
On heritability of growth stresses in EB and EA. Woodville, harewood and marlb
Anatomy study from loops, reporting G-layer, MFAs etc
On G-layer enzyme removal results
Paper presenting modeling work
