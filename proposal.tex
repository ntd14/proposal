...
Guitard et al 1999 used a S2 layer model which took the transmition of shear
between fibres into account, resulting in non-zero shear moduli. Previously
intergral conditions had been used to goven the longitudinal stresses,
presumably as they satasfy the nessassery condtion implicet within stress feild
equlibram conditions, Guitard et al 1999 however introduced a local condition on
every elementory volume. They argue that although this approch does not satasy
the nessassery equlibram condtions it provides better agreement with
experimental results when combined with dimentional chenages within the
microfibril bundel. In particular this model provides a much better prediction
of transverse strains while being less complex than previous attmepts.

Yamamoto et al (origon of the biomechanical properties of wood related to fine
structuer of the multi layer cell wall) 1999 further advance his 1998 model to
include drying stresses and moisture depened youngs modulus, however little
changes were made with regard to the growth stress model. This paper was
followed by-----
